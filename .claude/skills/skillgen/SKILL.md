...
After all files are written, print this summary block:
...
Generated N skill files in .claude/skills/:
  ...
  testing.md                 (XX lines)
  imports-and-dependencies.md (XX lines)
  documentation.md           (XX lines)
  architecture.md            (XX lines)
  code-style.md              (XX lines)
  logging-and-observability.md (XX lines)

Skipped: [list categories that were skipped, with reason — "no patterns" or "hand-written file"]
...
Only list the files that were actually written. Adjust the count accordingly.
