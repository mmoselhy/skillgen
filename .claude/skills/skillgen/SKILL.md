...
- Use `##` for each category title, `###` for subcategories, `-` for bullet points.
...
Generated skill file: .claude/skills/project-conventions/SKILL.md (XX lines)
  Sections: naming-conventions, error-handling, testing, ...
...
To share with your team: git add .claude/skills/project-conventions/ && git commit -m "Add AI skill files"
```
